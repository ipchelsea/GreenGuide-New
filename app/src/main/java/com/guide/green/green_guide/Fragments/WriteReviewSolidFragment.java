...
public class WriteReviewSolidFragment extends WriteReviewActivity.WriteReviewPage {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View parent = inflater.inflate(R.layout.fragment_write_solid, null);
        parent.findViewById(R.id.solid_next).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        parent.findViewById(R.id.solid_prev).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mOnPageChangeListener != null) {
