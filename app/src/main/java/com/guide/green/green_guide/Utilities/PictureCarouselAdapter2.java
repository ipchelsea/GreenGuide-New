...
public class PictureCarouselAdapter2 extends RecyclerView.Adapter<PictureCarouselAdapter2.CarouselViewHolder> {
    ...
    public PictureCarouselAdapter2(Context context, @NonNull List<String> imgUrls) {
        mContext = context;
        mImageUrls = imgUrls;
